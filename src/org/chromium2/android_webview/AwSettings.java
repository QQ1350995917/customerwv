...
import android.webkit2.WebSettings;
import android.webkit2.WebSettings.PluginState;

/**
 * Stores Android WebView specific settings that does not need to be synced to WebKit.
 * Use {@link org.chromium2.content.browser.ContentSettings} for WebKit settings.
 *
