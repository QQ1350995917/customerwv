 ...
 * Original file: public/android/java/src/org/chromium/content/common/IChildProcessService.aidl
 */
package org.chromium2.content.common;
...
{
private static final java.lang.String DESCRIPTOR = "IChildProcessService";
...
/**
 * Cast an IBinder object into an IChildProcessService interface,
...
return new IChildProcessService.Stub.Proxy(obj);
}
...
IChildProcessCallback _arg1;
_arg1 = IChildProcessCallback.Stub.asInterface(data.readStrongBinder());
...
@Override public int setupConnection(android.os.Bundle args, IChildProcessCallback callback) throws android.os.RemoteException
{
...
public int setupConnection(android.os.Bundle args, IChildProcessCallback callback) throws android.os.RemoteException;
}
