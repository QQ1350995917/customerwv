 ...
 * Original file: public/android/java/src/org/chromium/content/common/IChildProcessCallback.aidl
 */
package org.chromium2.content.common;
public interface IChildProcessCallback extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements IChildProcessCallback
{
private static final java.lang.String DESCRIPTOR = "IChildProcessCallback";
...
/**
 * Cast an IBinder object into an IChildProcessCallback interface,
 * generating a proxy if needed.
 */
public static IChildProcessCallback asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
...
return new IChildProcessCallback.Stub.Proxy(obj);
}
