...
public class ResourceProvider {
    ...
    static void registerResources(Context context) {
        ...
        R.dimen.link_preview_overlay_radius =
                R.dimen.webviewchromium_link_preview_overlay_radius;

        // drawable
        R.drawable.ondemand_overlay =
                R.drawable.webviewchromium_ondemand_overlay;

        org.chromium.ui.R.drawable.color_picker_advanced_select_handle =
                R.drawable.webviewchromium_color_picker_advanced_select_handle;

        // id

        R.id.position_in_year =
                R.id.webviewchromium_position_in_year;
        R.id.year = R.id.webviewchromium_year;
        R.id.pickers = R.id.webviewchromium_pickers;
        R.id.date_picker =
                R.id.webviewchromium_date_picker;
        R.id.select_action_menu_select_all =
                R.id.webviewchromium_select_action_menu_select_all;
        R.id.select_action_menu_cut =
                R.id.webviewchromium_select_action_menu_cut;
        R.id.select_action_menu_copy =
                R.id.webviewchromium_select_action_menu_copy;
